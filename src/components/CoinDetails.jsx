...
import { Radio, RadioGroup, HStack, VStack } from '@chakra-ui/react';
    ...
    <Container maxW={'container.xl'}>
      {loading ? (
        ...
        <>
          ...
          <VStack spacing={'4'} p="16" mt={-5} alignItems={'flex-start'}>
            <Text fontSize={'small'} alignSelf={'center'} opacity={'0.7'}>
              Last Updated on{' '}
              {Date(coin.market_date_last_updated).split('G')[0]}
            </Text>
            <Img
